...
const signIn = async (req, res) => {
  try {
    ...
    const token = await AuthService.authorize({_id: user._id, email: user.email, firstName: user.firstName, lastName: user.lastName})
...
const signUp = async (req, res) => {
  try {
    ...
    let token = await AuthService.authorize({_id: user._id, email: user.email, firstName: user.firstName, lastName: user.lastName})
